...
namespace Hospital_Management
{
    ...
    {
        SqlConnection cn = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Current\Hospital Management\Hospital Management\hospital.mdf;Integrated Security=True");
